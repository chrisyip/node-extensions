...
var isFunction = require('./var/isFunction'),
    ...
    flattenArrayLike = require('./var/flattenArrayLike'),
    isNativeCode = require('./var/isNativeCode'),
    filter = require('./var/arrayFilter'),
...
if (!isNativeCode(proto.contains)) {
  proto.contains = function contains (element, position) {
